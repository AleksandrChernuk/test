...
})({"a8fLx":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "fddcb0aaf616078c";
"use strict";
...
var _imagesApi = require("../data/imagesApi");
...
function onSubmit(e) {
    ...
    if (!query.trim()) {
        ...
        (0, _notiflixNotifyAio.Notify).failure(`Пусто`);
        return;
    }
    galleryEl.innerHTML = "";
    (0, _imagesApi.fetchImages)(query, page, perPage).then((data)=>{
    ...
    }).catch((e)=>console.log(e)).finally(()=>searchForm.reset());
}
...
},{"../data/imagesApi":"c8HCi","notiflix/build/notiflix-notify-aio":"eXQLZ","simplelightbox":"9ydBq","simplelightbox/dist/simple-lightbox.min.css":"kaxSc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"c8HCi":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
const fetchImages = async (query, page, perPage)=>{
    try {
        const res = await (0, _axiosDefault.default).get(`https://pixabay.com/api/?key=${API_KEY}&q=${query}&image_type=photo&orientation=horizontal&safesearch=true&page=${page}&per_page=${perPage}`);
        return res.data;
    } catch (error) {
        console.log(error);
    }
...
},{}],"kaxSc":[function() {},{}]},["a8fLx","4XIGb"], "4XIGb", "parcelRequirefc40")

//# sourceMappingURL=images.f616078c.js.map
